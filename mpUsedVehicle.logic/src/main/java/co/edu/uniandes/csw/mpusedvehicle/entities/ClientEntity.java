...
@NamedQueries({
    ...
    @NamedQuery(name = "Client.getIdANDUserName", query = "select u from ClientEntity u"),
    @NamedQuery(name = "Client.getById", query = "select u from ClientEntity u WHERE u.id = :id"),
})
