...
public class vehicleTest { 
    ...
    public static String PATHVEHICLE = "/vehicles";
    public static int Ok = 200;
    public static int Created = 201;
    public static int OkWithoutContent = 204;
    public static List<VehicleDTO> oraculo = new ArrayList<>();
    ...
    public static Archive<?> createDeployment() { 
        ...
        WebArchive war = ShrinkWrap 
                // Nombre del Proyecto "VehicleBasico.web" seguido de ".war". Debe ser el mismo nombre del proyecto web que contiene los javascript y los  servicios Rest
                .create(WebArchive.class, "VehicleBasico.web.war") 
    ...
    @Test 
    @RunAsClient 
    public void t1CreateVehicleService() throws IOException { 
        /*
        VehicleDTO vehicle = oraculo.get(0); 
        Client cliente = ClientBuilder.newClient(); 
        Response response = cliente.target(URLBASE + PATHVEHICLE) 
                .request() 
